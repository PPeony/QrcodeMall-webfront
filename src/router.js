...
import GoodsPromotion from "./pages/public/GoodsPromotion";
import AddPromotionGoods from "./pages/public/AddPromotionGoods";
// import CodeView from "../code-view/view.html"
import Vue from "vue";
            ...
            children: [
                {
                    ...
                    path: 'addPromotionGoods',
                    component: AddPromotionGoods
                },
                {
                    path: 'shopcart',
                    component: ShopCart
...
router.beforeEach((to, from, next) => {
    ...
    console.log(routers,to.name,from.name);
    var user = sessionStorage.getItem('user');
    var fatherRouter = routers[1];
    console.log(fatherRouter+" "+user)
