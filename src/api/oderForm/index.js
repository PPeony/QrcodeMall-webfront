...
export const generatePromotionOrderForm = data => {
    return server({
        method: 'post',
        url: '/orderForm/generateOrderForm'+'?promotionId='+data.promotionId,
        data:data.data
    });
};
...
export const oneOrderForm = params => {
    return server({
        method: 'get',
        url: '/orderForm/oneOrderForm',
        params
    });
};
